    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="<?= route('console.coupons.create') ?>" class="btn btn-success">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover bs-table">
                            ...
                            <?php if ($coupons): foreach ($coupons as $coupon): ?>
                                <tr>
                                    <td class="text-right">
                                        <a href="<?= route('console.coupons.edit', ['id' => $coupon['id']]) ?>"
                                           class="btn btn-sm btn-default">
                                            <i class="fa fa-fw fa-pencil-alt"></i> Изменить
                                        </a>
                                        <a href="<?= route('console.coupons.delete', ['id' => $coupon['id']]) ?>"
